...
const RESOLUME_MAP: Record<string, string | null> = {
  ...
  // Pad row 2 = PENDING — planned as Clip Triggers for Resolume Row 4 (Foreground), cols 1–7; col 8 unmapped
  "pad-r2-c1": "Clip Trigger \u2014 Row 4, Col 1", "pad-r2-c2": "Clip Trigger \u2014 Row 4, Col 2",
  "pad-r2-c3": "Clip Trigger \u2014 Row 4, Col 3", "pad-r2-c4": "Clip Trigger \u2014 Row 4, Col 4",
  "pad-r2-c5": "Clip Trigger \u2014 Row 4, Col 5", "pad-r2-c6": "Clip Trigger \u2014 Row 4, Col 6",
  "pad-r2-c7": "Clip Trigger \u2014 Row 4, Col 7", "pad-r2-c8": null,
  ...
  "pad-r3-c7": "Clip Trigger \u2014 Layer 3, Col 7", "pad-r3-c8": null,
  ...
  "pad-r4-c7": "Clip Trigger \u2014 Layer 2, Col 7", "pad-r4-c8": null,
  ...
  "pad-r5-c7": "Clip Trigger \u2014 Layer 1, Col 7", "pad-r5-c8": null,

  // Scene Launch — all 5 unmapped in Resolume default
  "scene-1": null, "scene-2": null, "scene-3": null, "scene-4": null, "scene-5": null,
...
const DEFAULT_ZONES: Zone[] = [
  ...
  { id: "pad-r1-c1", label: "Clip Pad \u2014 Row 5, Col 1", type: "pad", x: 5, y: 18.93, w: 6.77, h: 4.6 },
  { id: "pad-r1-c2", label: "Clip Pad \u2014 Row 5, Col 2", type: "pad", x: 12.1, y: 18.93, w: 6.6, h: 4.6 },
  { id: "pad-r1-c3", label: "Clip Pad \u2014 Row 5, Col 3", type: "pad", x: 19.2, y: 19.07, w: 6.6, h: 4.6 },
  { id: "pad-r1-c4", label: "Clip Pad \u2014 Row 5, Col 4", type: "pad", x: 26.22, y: 18.93, w: 6.6, h: 4.47 },
  { id: "pad-r1-c5", label: "Clip Pad \u2014 Row 5, Col 5", type: "pad", x: 33.4, y: 18.93, w: 6.6, h: 4.6 },
  { id: "pad-r1-c6", label: "Clip Pad \u2014 Row 5, Col 6", type: "pad", x: 40.5, y: 18.93, w: 6.6, h: 4.33 },
  { id: "pad-r1-c7", label: "Clip Pad \u2014 Row 5, Col 7", type: "pad", x: 47.43, y: 18.8, w: 6.6, h: 4.73 },
  { id: "pad-r1-c8", label: "Clip Pad \u2014 Row 5, Col 8", type: "pad", x: 54.37, y: 18.93, w: 6.6, h: 4.6 },
  { id: "pad-r2-c1", label: "Clip Pad \u2014 Row 4, Col 1", type: "pad", x: 5.33, y: 24.8, w: 6.43, h: 3.93 },
  { id: "pad-r2-c2", label: "Clip Pad \u2014 Row 4, Col 2", type: "pad", x: 12.35, y: 25.07, w: 6.35, h: 3.8 },
  { id: "pad-r2-c3", label: "Clip Pad \u2014 Row 4, Col 3", type: "pad", x: 19.37, y: 24.67, w: 6.43, h: 4.33 },
  { id: "pad-r2-c4", label: "Clip Pad \u2014 Row 4, Col 4", type: "pad", x: 26.55, y: 24.93, w: 6.35, h: 3.93 },
  { id: "pad-r2-c5", label: "Clip Pad \u2014 Row 4, Col 5", type: "pad", x: 33.4, y: 24.8, w: 6.6, h: 4.2 },
  { id: "pad-r2-c6", label: "Clip Pad \u2014 Row 4, Col 6", type: "pad", x: 40.58, y: 24.8, w: 6.35, h: 4.07 },
  { id: "pad-r2-c7", label: "Clip Pad \u2014 Row 4, Col 7", type: "pad", x: 47.68, y: 24.67, w: 6.35, h: 4.07 },
  { id: "pad-r2-c8", label: "Clip Pad \u2014 Row 4, Col 8", type: "pad", x: 54.7, y: 24.8, w: 6.35, h: 3.93 },
  ...
  { id: "pad-r4-c1", label: "Clip Pad \u2014 Row 2, Col 1", type: "pad", x: 5.25, y: 35.87, w: 6.6, h: 3.8 },
  { id: "pad-r4-c2", label: "Clip Pad \u2014 Row 2, Col 2", type: "pad", x: 12.43, y: 35.73, w: 6.52, h: 3.8 },
  { id: "pad-r4-c3", label: "Clip Pad \u2014 Row 2, Col 3", type: "pad", x: 19.2, y: 35.6, w: 6.6, h: 4.07 },
  { id: "pad-r4-c4", label: "Clip Pad \u2014 Row 2, Col 4", type: "pad", x: 26.55, y: 35.73, w: 6.35, h: 3.8 },
  { id: "pad-r4-c5", label: "Clip Pad \u2014 Row 2, Col 5", type: "pad", x: 33.57, y: 35.6, w: 6.35, h: 3.93 },
  { id: "pad-r4-c6", label: "Clip Pad \u2014 Row 2, Col 6", type: "pad", x: 40.5, y: 35.73, w: 6.35, h: 3.8 },
  { id: "pad-r4-c7", label: "Clip Pad \u2014 Row 2, Col 7", type: "pad", x: 47.6, y: 35.6, w: 6.43, h: 3.93 },
  { id: "pad-r4-c8", label: "Clip Pad \u2014 Row 2, Col 8", type: "pad", x: 54.78, y: 35.73, w: 6.35, h: 3.8 },
  { id: "pad-r5-c1", label: "Clip Pad \u2014 Row 1, Col 1", type: "pad", x: 5.42, y: 41.2, w: 6.27, h: 3.8 },
  { id: "pad-r5-c2", label: "Clip Pad \u2014 Row 1, Col 2", type: "pad", x: 12.35, y: 41.07, w: 6.35, h: 3.93 },
  { id: "pad-r5-c3", label: "Clip Pad \u2014 Row 1, Col 3", type: "pad", x: 19.53, y: 41.2, w: 6.18, h: 3.67 },
  { id: "pad-r5-c4", label: "Clip Pad \u2014 Row 1, Col 4", type: "pad", x: 26.55, y: 40.93, w: 6.35, h: 4.07 },
  { id: "pad-r5-c5", label: "Clip Pad \u2014 Row 1, Col 5", type: "pad", x: 33.48, y: 40.93, w: 6.43, h: 4.07 },
  { id: "pad-r5-c6", label: "Clip Pad \u2014 Row 1, Col 6", type: "pad", x: 40.75, y: 41.2, w: 6.35, h: 3.8 },
  { id: "pad-r5-c7", label: "Clip Pad \u2014 Row 1, Col 7", type: "pad", x: 47.85, y: 41.07, w: 6.18, h: 3.93 },
  { id: "pad-r5-c8", label: "Clip Pad \u2014 Row 1, Col 8", type: "pad", x: 54.87, y: 41.07, w: 6.18, h: 3.8 },
