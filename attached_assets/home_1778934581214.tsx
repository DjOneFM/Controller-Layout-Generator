...
const RESOLUME_MAP: Record<string, string | null> = {
  // Assignable Knobs — first 3 map to Dashboard Dial Hue per layer
  ...
  // Pad row 1 (top physical row) = Trigger Column 1–7
  "pad-r1-c1": "Trigger Column 1", "pad-r1-c2": "Trigger Column 2",
  "pad-r1-c3": "Trigger Column 3", "pad-r1-c4": "Trigger Column 4",
  "pad-r1-c5": "Trigger Column 5", "pad-r1-c6": "Trigger Column 6",
  "pad-r1-c7": "Trigger Column 7", "pad-r1-c8": null,

  // Pad row 2 = PENDING — planned as Clip Triggers for Resolume Layer 4 (Foreground), cols 1–7; col 8 unmapped
  "pad-r2-c1": "Clip Trigger \u2014 Layer 4, Col 1", "pad-r2-c2": "Clip Trigger \u2014 Layer 4, Col 2",
  "pad-r2-c3": "Clip Trigger \u2014 Layer 4, Col 3", "pad-r2-c4": "Clip Trigger \u2014 Layer 4, Col 4",
  "pad-r2-c5": "Clip Trigger \u2014 Layer 4, Col 5", "pad-r2-c6": "Clip Trigger \u2014 Layer 4, Col 6",
  "pad-r2-c7": "Clip Trigger \u2014 Layer 4, Col 7", "pad-r2-c8": "Clip Trigger \u2014 Layer 4, Col 8",

  // Pad rows 3–5 = Clip Triggers (row 3 = Layer 3, row 4 = Layer 2, row 5 = Layer 1)
  "pad-r3-c1": "Clip Trigger \u2014 Layer 3, Col 1", "pad-r3-c2": "Clip Trigger \u2014 Layer 3, Col 2",
  "pad-r3-c3": "Clip Trigger \u2014 Layer 3, Col 3", "pad-r3-c4": "Clip Trigger \u2014 Layer 3, Col 4",
  "pad-r3-c5": "Clip Trigger \u2014 Layer 3, Col 5", "pad-r3-c6": "Clip Trigger \u2014 Layer 3, Col 6",
  "pad-r3-c7": "Clip Trigger \u2014 Layer 3, Col 7", "pad-r3-c8": "Clip Trigger \u2014 Layer 3, Col 8",
  "pad-r4-c1": "Clip Trigger \u2014 Layer 2, Col 1", "pad-r4-c2": "Clip Trigger \u2014 Layer 2, Col 2",
  "pad-r4-c3": "Clip Trigger \u2014 Layer 2, Col 3", "pad-r4-c4": "Clip Trigger \u2014 Layer 2, Col 4",
  "pad-r4-c5": "Clip Trigger \u2014 Layer 2, Col 5", "pad-r4-c6": "Clip Trigger \u2014 Layer 2, Col 6",
  "pad-r4-c7": "Clip Trigger \u2014 Layer 2, Col 7", "pad-r4-c8": "Clip Trigger \u2014 Layer 2, Col 8",
  "pad-r5-c1": "Clip Trigger \u2014 Layer 1, Col 1", "pad-r5-c2": "Clip Trigger \u2014 Layer 1, Col 2",
  "pad-r5-c3": "Clip Trigger \u2014 Layer 1, Col 3", "pad-r5-c4": "Clip Trigger \u2014 Layer 1, Col 4",
  "pad-r5-c5": "Clip Trigger \u2014 Layer 1, Col 5", "pad-r5-c6": "Clip Trigger \u2014 Layer 1, Col 6",
  "pad-r5-c7": "Clip Trigger \u2014 Layer 1, Col 7", "pad-r5-c8": "Clip Trigger \u2014 Layer 1, Col 8",

  // Scene Launch — all 5 unmapped in Resolume default
  "scene-1": null, "scene-2": null, "scene-3": "Select Layer 3", "scene-4": "Select Layer 2", "scene-5": "Select Layer 1",

  // Stop All Clips button
  "stop-all": "Stop All Clips",

  // Clip Stop row = Clear Layer 1–3
  ...
  // Track Selectors = Next (A|B) / Previous Clip for layers 1–3
  ...
  "track-sel-master": "Preview Composition",

  // Track Activator (#) = Solo per layer
  ...
  // Crossfade Assign (A|B) = Bypass per layer
  ...
  // Record Arm (●) = Bypass per layer (O button per Resolume template)
  ...
  // Volume Faders — 1 = Composition Master, 2–3 = Layer Faders
  ...
  // Device Control Knobs 1–4 = Dashboard Dials Composition, 5–7 = Select Layer, 8 = Eject/Preview
...
const PENDING_STYLE  = { bg: "rgba(234,179,8,0.25)",  border: "#eab308" };
const PENDING_HOVER  = { bg: "rgba(234,179,8,0.50)",  border: "#fbbf24" };

// Zones planned but not yet confirmed mapped in Resolume — shown in yellow
const PENDING_ZONES = new Set([
  "pad-r2-c1", "pad-r2-c2", "pad-r2-c3", "pad-r2-c4",
  "pad-r2-c5", "pad-r2-c6", "pad-r2-c7",
  "pad-r2-c8", "pad-r3-c8", "pad-r4-c8", "pad-r5-c8",
]);
...
const DEFAULT_ZONES: Zone[] = [
  ...
  { id: "pad-r1-c1", label: "Clip Launch \u2014 Layer 5, Col 1", type: "pad", x: 5, y: 18.93, w: 6.77, h: 4.6 },
  { id: "pad-r1-c2", label: "Clip Launch \u2014 Layer 5, Col 2", type: "pad", x: 12.1, y: 18.93, w: 6.6, h: 4.6 },
  { id: "pad-r1-c3", label: "Clip Launch \u2014 Layer 5, Col 3", type: "pad", x: 19.2, y: 19.07, w: 6.6, h: 4.6 },
  { id: "pad-r1-c4", label: "Clip Launch \u2014 Layer 5, Col 4", type: "pad", x: 26.22, y: 18.93, w: 6.6, h: 4.47 },
  { id: "pad-r1-c5", label: "Clip Launch \u2014 Layer 5, Col 5", type: "pad", x: 33.4, y: 18.93, w: 6.6, h: 4.6 },
  { id: "pad-r1-c6", label: "Clip Launch \u2014 Layer 5, Col 6", type: "pad", x: 40.5, y: 18.93, w: 6.6, h: 4.33 },
  { id: "pad-r1-c7", label: "Clip Launch \u2014 Layer 5, Col 7", type: "pad", x: 47.43, y: 18.8, w: 6.6, h: 4.73 },
  { id: "pad-r1-c8", label: "Clip Launch \u2014 Layer 5, Col 8", type: "pad", x: 54.37, y: 18.93, w: 6.6, h: 4.6 },
  { id: "pad-r2-c1", label: "Clip Launch \u2014 Layer 4, Col 1", type: "pad", x: 5.33, y: 24.8, w: 6.43, h: 3.93 },
  { id: "pad-r2-c2", label: "Clip Launch \u2014 Layer 4, Col 2", type: "pad", x: 12.35, y: 25.07, w: 6.35, h: 3.8 },
  { id: "pad-r2-c3", label: "Clip Launch \u2014 Layer 4, Col 3", type: "pad", x: 19.37, y: 24.67, w: 6.43, h: 4.33 },
  { id: "pad-r2-c4", label: "Clip Launch \u2014 Layer 4, Col 4", type: "pad", x: 26.55, y: 24.93, w: 6.35, h: 3.93 },
  { id: "pad-r2-c5", label: "Clip Launch \u2014 Layer 4, Col 5", type: "pad", x: 33.4, y: 24.8, w: 6.6, h: 4.2 },
  { id: "pad-r2-c6", label: "Clip Launch \u2014 Layer 4, Col 6", type: "pad", x: 40.58, y: 24.8, w: 6.35, h: 4.07 },
  { id: "pad-r2-c7", label: "Clip Launch \u2014 Layer 4, Col 7", type: "pad", x: 47.68, y: 24.67, w: 6.35, h: 4.07 },
  { id: "pad-r2-c8", label: "Clip Launch \u2014 Layer 4, Col 8", type: "pad", x: 54.7, y: 24.8, w: 6.35, h: 3.93 },
  { id: "pad-r3-c1", label: "Clip Launch \u2014 Layer 3, Col 1", type: "pad", x: 5.42, y: 30.27, w: 6.35, h: 4.2 },
  { id: "pad-r3-c2", label: "Clip Launch \u2014 Layer 3, Col 2", type: "pad", x: 12.27, y: 30.27, w: 6.52, h: 4.2 },
  { id: "pad-r3-c3", label: "Clip Launch \u2014 Layer 3, Col 3", type: "pad", x: 19.28, y: 30.27, w: 6.43, h: 4.2 },
  { id: "pad-r3-c4", label: "Clip Launch \u2014 Layer 3, Col 4", type: "pad", x: 26.38, y: 30.27, w: 6.43, h: 3.93 },
  { id: "pad-r3-c5", label: "Clip Launch \u2014 Layer 3, Col 5", type: "pad", x: 33.32, y: 30.27, w: 6.6, h: 4.07 },
  { id: "pad-r3-c6", label: "Clip Launch \u2014 Layer 3, Col 6", type: "pad", x: 40.67, y: 30.13, w: 6.27, h: 4.2 },
  { id: "pad-r3-c7", label: "Clip Launch \u2014 Layer 3, Col 7", type: "pad", x: 47.6, y: 30.4, w: 6.35, h: 3.93 },
  { id: "pad-r3-c8", label: "Clip Launch \u2014 Layer 3, Col 8", type: "pad", x: 54.62, y: 30.13, w: 6.52, h: 4.2 },
  { id: "pad-r4-c1", label: "Clip Launch \u2014 Layer 2, Col 1", type: "pad", x: 5.25, y: 35.87, w: 6.6, h: 3.8 },
  { id: "pad-r4-c2", label: "Clip Launch \u2014 Layer 2, Col 2", type: "pad", x: 12.43, y: 35.73, w: 6.52, h: 3.8 },
  { id: "pad-r4-c3", label: "Clip Launch \u2014 Layer 2, Col 3", type: "pad", x: 19.2, y: 35.6, w: 6.6, h: 4.07 },
  { id: "pad-r4-c4", label: "Clip Launch \u2014 Layer 2, Col 4", type: "pad", x: 26.55, y: 35.73, w: 6.35, h: 3.8 },
  { id: "pad-r4-c5", label: "Clip Launch \u2014 Layer 2, Col 5", type: "pad", x: 33.57, y: 35.6, w: 6.35, h: 3.93 },
  { id: "pad-r4-c6", label: "Clip Launch \u2014 Layer 2, Col 6", type: "pad", x: 40.5, y: 35.73, w: 6.35, h: 3.8 },
  { id: "pad-r4-c7", label: "Clip Launch \u2014 Layer 2, Col 7", type: "pad", x: 47.6, y: 35.6, w: 6.43, h: 3.93 },
  { id: "pad-r4-c8", label: "Clip Launch \u2014 Layer 2, Col 8", type: "pad", x: 54.78, y: 35.73, w: 6.35, h: 3.8 },
  { id: "pad-r5-c1", label: "Clip Launch \u2014 Layer 1, Col 1", type: "pad", x: 5.42, y: 41.2, w: 6.27, h: 3.8 },
  { id: "pad-r5-c2", label: "Clip Launch \u2014 Layer 1, Col 2", type: "pad", x: 12.35, y: 41.07, w: 6.35, h: 3.93 },
  { id: "pad-r5-c3", label: "Clip Launch \u2014 Layer 1, Col 3", type: "pad", x: 19.53, y: 41.2, w: 6.18, h: 3.67 },
  { id: "pad-r5-c4", label: "Clip Launch \u2014 Layer 1, Col 4", type: "pad", x: 26.55, y: 40.93, w: 6.35, h: 4.07 },
  { id: "pad-r5-c5", label: "Clip Launch \u2014 Layer 1, Col 5", type: "pad", x: 33.48, y: 40.93, w: 6.43, h: 4.07 },
  { id: "pad-r5-c6", label: "Clip Launch \u2014 Layer 1, Col 6", type: "pad", x: 40.75, y: 41.2, w: 6.35, h: 3.8 },
  { id: "pad-r5-c7", label: "Clip Launch \u2014 Layer 1, Col 7", type: "pad", x: 47.85, y: 41.07, w: 6.18, h: 3.93 },
  { id: "pad-r5-c8", label: "Clip Launch \u2014 Layer 1, Col 8", type: "pad", x: 54.87, y: 41.07, w: 6.18, h: 3.8 },
  ...
  { id: "activator-1", label: "Track Activator (#) \u2014 Track 1", type: "button-green", x: 5.25, y: 58.83, w: 3.02, h: 3.47 },
  { id: "activator-2", label: "Track Activator (#) \u2014 Track 2", type: "button-green", x: 12.35, y: 58.83, w: 2.93, h: 3.47 },
  { id: "activator-3", label: "Track Activator (#) \u2014 Track 3", type: "button-green", x: 19.53, y: 58.97, w: 2.85, h: 3.33 },
  { id: "activator-4", label: "Track Activator (#) \u2014 Track 4", type: "button-green", x: 26.47, y: 58.83, w: 2.6, h: 3.6 },
  { id: "activator-5", label: "Track Activator (#) \u2014 Track 5", type: "button-green", x: 33.48, y: 58.83, w: 2.93, h: 3.47 },
  { id: "activator-6", label: "Track Activator (#) \u2014 Track 6", type: "button-green", x: 40.58, y: 58.83, w: 2.93, h: 3.47 },
  { id: "activator-7", label: "Track Activator (#) \u2014 Track 7", type: "button-green", x: 47.77, y: 58.97, w: 2.68, h: 3.33 },
  { id: "activator-8", label: "Track Activator (#) \u2014 Track 8", type: "button-green", x: 54.95, y: 58.97, w: 2.27, h: 3.33 },
  { id: "crossfade-1", label: "Crossfade Assign (A|B) \u2014 Track 1", type: "button", x: 8.92, y: 58.83, w: 2.6, h: 3.33 },
  { id: "crossfade-2", label: "Crossfade Assign (A|B) \u2014 Track 2", type: "button", x: 16.02, y: 58.97, w: 2.77, h: 3.33 },
  { id: "crossfade-3", label: "Crossfade Assign (A|B) \u2014 Track 3", type: "button", x: 23.03, y: 58.97, w: 2.52, h: 3.33 },
  { id: "crossfade-4", label: "Crossfade Assign (A|B) \u2014 Track 4", type: "button", x: 30.13, y: 58.83, w: 2.6, h: 3.73 },
  { id: "crossfade-5", label: "Crossfade Assign (A|B) \u2014 Track 5", type: "button", x: 36.98, y: 59.1, w: 2.85, h: 3.2 },
  { id: "crossfade-6", label: "Crossfade Assign (A|B) \u2014 Track 6", type: "button", x: 44.17, y: 59.1, w: 2.85, h: 3.47 },
  { id: "crossfade-7", label: "Crossfade Assign (A|B) \u2014 Track 7", type: "button", x: 51.35, y: 58.83, w: 2.6, h: 3.33 },
  { id: "crossfade-8", label: "Crossfade Assign (A|B) \u2014 Track 8", type: "button", x: 58.37, y: 58.97, w: 2.85, h: 3.47 },
  { id: "solo-1", label: "Solo (S) \u2014 Track 1", type: "button", x: 5.5, y: 64.03, w: 2.52, h: 3.2 },
  { id: "solo-2", label: "Solo (S) \u2014 Track 2", type: "button", x: 12.68, y: 64.17, w: 2.35, h: 2.93 },
  { id: "solo-3", label: "Solo (S) \u2014 Track 3", type: "button", x: 19.53, y: 63.9, w: 2.52, h: 3.47 },
  { id: "solo-4", label: "Solo (S) \u2014 Track 4", type: "button", x: 26.55, y: 63.9, w: 2.68, h: 3.33 },
  { id: "solo-5", label: "Solo (S) \u2014 Track 5", type: "button", x: 33.48, y: 63.9, w: 2.93, h: 3.6 },
  { id: "solo-6", label: "Solo (S) \u2014 Track 6", type: "button", x: 40.75, y: 63.9, w: 2.6, h: 3.2 },
  { id: "solo-7", label: "Solo (S) \u2014 Track 7", type: "button", x: 47.77, y: 64.03, w: 2.52, h: 3.2 },
  { id: "solo-8", label: "Solo (S) \u2014 Track 8", type: "button", x: 54.87, y: 64.17, w: 2.6, h: 3.07 },
  { id: "recarm-1", label: "Record Arm (\u25cf) \u2014 Track 1", type: "button-red", x: 8.92, y: 63.9, w: 2.85, h: 3.6 },
  { id: "recarm-2", label: "Record Arm (\u25cf) \u2014 Track 2", type: "button-red", x: 16.02, y: 64.03, w: 2.6, h: 3.33 },
  { id: "recarm-3", label: "Record Arm (\u25cf) \u2014 Track 3", type: "button-red", x: 22.95, y: 63.9, w: 2.77, h: 3.47 },
  { id: "recarm-4", label: "Record Arm (\u25cf) \u2014 Track 4", type: "button-red", x: 30.05, y: 63.9, w: 2.68, h: 3.6 },
  { id: "recarm-5", label: "Record Arm (\u25cf) \u2014 Track 5", type: "button-red", x: 37.07, y: 64.03, w: 2.77, h: 3.33 },
  { id: "recarm-6", label: "Record Arm (\u25cf) \u2014 Track 6", type: "button-red", x: 44.17, y: 63.77, w: 3.02, h: 3.6 },
  { id: "recarm-7", label: "Record Arm (\u25cf) \u2014 Track 7", type: "button-red", x: 51.18, y: 63.9, w: 3.02, h: 3.6 },
  { id: "recarm-8", label: "Record Arm (\u25cf) \u2014 Track 8", type: "button-red", x: 58.45, y: 64.03, w: 2.68, h: 3.33 },
...
export default function Home() {
  ...
  const mappedCount = zones.filter(z => !PENDING_ZONES.has(z.id) && RESOLUME_MAP[z.id] != null).length;
  const pendingCount = zones.filter(z => PENDING_ZONES.has(z.id)).length;
  const unmappedCount = zones.length - mappedCount - pendingCount;
  ...
  const isPending = activeZone ? PENDING_ZONES.has(activeZone.id) : false;
  const mapped = activeZone ? (isPending ? "Planned \u2014 Not yet confirmed in Resolume" : RESOLUME_MAP[activeZone.id] ?? null) : null;
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap", background: "#1a1a20", border: "1px solid #2a2a32", borderRadius: 8, padding: "8px 14px", width: "100%", maxWidth: 1200 }}>
        {!calibrating ? (
          <>
            ...
            <span style={{ fontSize: 11, fontWeight: 500, padding: "4px 11px", borderRadius: 5, background: "rgba(234,179,8,0.15)", color: "#fbbf24", border: "1px solid rgba(234,179,8,0.4)" }}>● {pendingCount} pending</span>
      ...
      >
        ...
        {calibrating ? (
          ...
          zones.map((zone) => {
            const isPending = PENDING_ZONES.has(zone.id);
            const isMapped = !isPending && RESOLUME_MAP[zone.id] != null;
            const s = isPending ? PENDING_STYLE : isMapped ? MAPPED_STYLE : UNMAPPED_STYLE;
            const h = isPending ? PENDING_HOVER  : isMapped ? MAPPED_HOVER  : UNMAPPED_HOVER;
      ...
      {!calibrating && (
        <div style={{ fontSize: 11, fontWeight: 500, color: "#475569", minHeight: 18, width: "100%", maxWidth: 1200, textAlign: "center", letterSpacing: "0.01em" }}>
          {infoText ? (
            PENDING_ZONES.has(activeZone?.id ?? "") ? (
              <><span style={{ color: "#fde68a" }}>{infoText.label}</span> <span style={{ color: "#334155" }}>→</span> <span style={{ color: "#fbbf24" }}>{RESOLUME_MAP[activeZone?.id ?? ""] ?? ""} — pending confirmation</span></>
            ) : infoText.mapped ? (
      ...
      {activeZone && (
        ...
        >
          ...
          <div style={{ padding: "11px 16px 13px" }}>
            ...
            {isPending ? (
              <>
                <div style={{ fontSize: 15, fontWeight: 600, color: "#fbbf24", lineHeight: 1.4, letterSpacing: "-0.01em" }}>{RESOLUME_MAP[activeZone.id]}</div>
                <div style={{ display: "inline-flex", alignItems: "center", gap: 4, borderRadius: 20, fontSize: 10, fontWeight: 700, padding: "3px 10px", marginTop: 9, letterSpacing: "0.06em", textTransform: "uppercase", background: "rgba(234,179,8,0.15)", color: "#fbbf24", border: "1px solid rgba(234,179,8,0.45)" }}>
